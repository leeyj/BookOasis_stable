...
# ─────────────────────────────────────────────────────────
DATA_DIRS="/app/db /app/covers /app/cache /app/logs /app/plugins /app/rclone"
...
if [ "$PUID" -ne 0 ]; then
    ...
    chown -R media_user:media_group /app/db /app/covers /app/cache /app/logs /app/plugins /app/rclone 2>/dev/null || true
