...
function ensureModal() {
  ...
  box.style.cssText = [
    ...
    'gap:0.7rem', 'background:rgba(var(--app-panel-rgb), 1)', 'border:1px solid rgba(var(--app-panel-border-rgb), 0.12)',
  ...
  box.innerHTML = `
    ...
    <textarea data-role="plugin-prompt-input" style="width:100%; box-sizing:border-box; background:var(--app-input-bg); color: var(--app-text-primary); border:1px solid rgba(var(--app-panel-border-rgb), 0.15); border-radius:6px; padding:0.55rem; font:inherit; resize:vertical;"></textarea>
